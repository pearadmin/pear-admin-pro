...
import { page, remove, removeBatch } from "@/api/module/remindTemplate";
...
export default {
  ...
  setup() {
    ...
    /// 列配置
    const columns = [
      { dataIndex: "subscribe", key: "subscribe", title: "订阅类型" },
      { dataIndex: "template", key: "template", title: "消息模板" },
      { dataIndex: "remark", key: "remark", title: "备注" },
      { dataIndex: "createName", key: "createName", title: "创建人" },
    ...
    const searchParam = [
        { key: "subscribe", type: "input", label: "模板类型"},
    ]

...
public class SysLogController extends BaseController {
    ...
    public Result operate(Page page, com.pearadmin.pro.modules.sys.domain.SysLog request){
    ...
    public Result login(Page page, com.pearadmin.pro.modules.sys.domain.SysLog request){

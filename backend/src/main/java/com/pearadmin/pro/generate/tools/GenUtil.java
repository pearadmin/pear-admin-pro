package com.pearadmin.pro.generate.tools;
...
import com.pearadmin.pro.generate.config.GenConfig;
...
public class GenUtil {
    ...
    public static String getDbType(String columnType) {
        if (StringUtil.indexOf(columnType, SystemConstant.BRACKET_LEFT) > 0) {
            return StringUtil.substringBefore(columnType, SystemConstant.BRACKET_LEFT);
        } else {
            return columnType;
        }
    }
    ...
    public static Integer getColumnLength(String columnType) {
        if (StringUtil.indexOf(columnType, SystemConstant.BRACKET_LEFT) > 0) {
            String length = StringUtil.substringBetween(columnType, SystemConstant.BRACKET_LEFT, SystemConstant.BRACKET_RIGHT);
